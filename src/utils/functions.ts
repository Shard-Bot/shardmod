...
export function getMemberJoinPosition(guild: Structures.Guild, userId: string) {
	let members = guild.members.sort((x, y) => x.joinedAtUnix - y.joinedAtUnix);
...
export async function timeoutMember(args: {
